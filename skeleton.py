#BELOW IS THE CODE PROVIDED BY PROFESSOR SOHN FOR CS288, SUMMER 2020 SEMESTER.
#I TAKE NO CREDIT WHATSOEVER FOR THE CODE BELOW.
#MY CONTRIBUTION TO THIS CODE IS SHOWN IN THE FILE "extract_and_inject.py"
